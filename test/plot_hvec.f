     ...
     1   srcvals,hvecs,rsigma)
      call prin2('rsigma=*',rsigma,24)
      

      call surf_vtk_plot_scalar(npatches,norders,ixyzs,iptype,
     1  npts,srccoefs,srcvals,rsigma,'divhvec30.vtk','a')
      
      call surf_quadratic_msh_vtk_plot(npatches,norders,ixyzs,iptype,
     1 npts,srccoefs,srcvals,'stell30.vtk','a')
