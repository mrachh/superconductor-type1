      ...
      fname = '../../fmm3dbie/geometries/genus_2.msh'
      call open_gidmsh2_geometry_mem(fname,npatches,npts)
      allocate(srcvals(12,npts),srccoefs(9,npts),wts(npts))
      allocate(norders(npatches),ixyzs(npatches+1),iptype(npatches))
      call open_gidmsh2_geometry(fname,npatches,norders,ixyzs,iptype,
     1   npts,srcvals,srccoefs,wts)

      call surf_vtk_plot(npatches,norders,ixyzs,iptype,npts,srccoefs,
     1   srcvals,'genus2.vtk','a')

      fname = '2torus_acycle.dat'
